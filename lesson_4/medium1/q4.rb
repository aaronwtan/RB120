...
# one called Hello and one called Goodbye. The Hello class should have
# a hi method that takes no arguments and prints "Hello".
# The Goodbye class should have a bye method to say "Goodbye".
# Make use of the Greeting class greet method when implementing
# the Hello and Goodbye classes - do not use any puts
# in the Hello or Goodbye classes.
class Greeting
  def greet(message)
    puts message
  end
